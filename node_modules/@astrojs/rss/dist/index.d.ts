...
export { rssSchema };
export declare type RSSOptions = {
...
declare type ValidatedRSSFeedItem = z.infer<typeof rssFeedItemValidator>;
declare type GlobResult = z.infer<typeof globResultValidator>;
